...
from .models import Students,AttendanceReport,Courses,Staffs,LeaveReportStaff,LeaveReportStudent,Subjects,Attendance,CustomUser,StudentResult,FeedBackStudent
...
def student_feedback_save(request):
    if request.method != "POST":
        ...
        return redirect('student_feedback')
         ...
         try:
               add_feedback = FeedBackStudent(student_id=student_obj,feedback=feedback,
                                            feedback_reply="")  
               add_feedback.save()
